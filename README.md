...
**Project**: insight-harbor-tool 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: An internal realtime company research and investigation tool 
...
```sh
git clone https://github.com/GPT-Engineer-App/insight-harbor-tool.git
cd insight-harbor-tool
npm i
